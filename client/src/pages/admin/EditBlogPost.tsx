  ...
  useEffect(() => {
    if (post) {
      setFormData({
        ...
        relatedServices: post.relatedServices ? JSON.parse(post.relatedServices) : [],
      });
    }
  }, [post]);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <Button
              type="submit"
              disabled={updatePostMutation.isPending || !formData.title || !formData.content || !formData.slug}
            >
